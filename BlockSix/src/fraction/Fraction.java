...
public class Fraction {
    ...
    Fraction(int numerator, int denominator){
        ...
        if(denominator <= 0) throw new IllegalArgumentException(denominator+" is not a legal floor");
    ...
    public void sum(Fraction sum){
        if(this.denominator != sum.denominator){
            System.out.println(new Fraction(this.numerator * sum.denominator + this.denominator*sum.numerator,
    ...
    public void minus (Fraction minus){
        if(this.denominator != minus.denominator){
            System.out.println(new Fraction(this.numerator * minus.denominator - this.denominator*minus.numerator,
    ...
    public void multiply (Fraction multiply){
        System.out.println(new Fraction(this.numerator * multiply.numerator,
    ...
    public void split (Fraction split){
        System.out.println(new Fraction(this.numerator * split.denominator,
                this.denominator * split.numerator));
    }
